        ...
        <div class="clkarenHomeOurServicesCardsParent">
            <a href="#" class="ourServicesCard">
                <div class="ourServicesCardHeader">
                    ...
                    <div class="ourServicesCardFooter">
                        <img decoding="async" src="https://templatekit.jegtheme.com/quinnie/wp-content/uploads/sites/170/2021/09/nose.png" alt="Rhinoplasty">
            ...
            <a href="#" class="ourServicesCard">
                <div class="ourServicesCardHeader">
                    <img src="<?php bloginfo('template_directory')?>/img/grid1.jpg"" alt="">
                    <div class="ourServicesCardFooter">
                        <img decoding="async" src="https://templatekit.jegtheme.com/quinnie/wp-content/uploads/sites/170/2021/09/breast.png" alt="Breast Implant">
                        <div class="ourServicesCardFooterInner">
                            <h3>کربوکسی تراپی تیرگی</h3>
                            <span>درمان سیاهی زیر چشم با استفاده از متد کربوکسی تراپی</span>
                            <span class="generalButton arrowButton" href="#">مشاهده</span>
            ...
            <a href="#" class="ourServicesCard">
                <div class="ourServicesCardHeader">
                    <img src="<?php bloginfo('template_directory')?>/img/grid1.jpg"" alt="">
                    <div class="ourServicesCardFooter">
                        <img decoding="async" src="https://templatekit.jegtheme.com/quinnie/wp-content/uploads/sites/170/2021/09/facelift.png" alt="Facelift">
                        <div class="ourServicesCardFooterInner">
                            <h3>کربوکسی تراپی تیرگی</h3>
                            <span>درمان سیاهی زیر چشم با استفاده از متد کربوکسی تراپی</span>
                            <span class="generalButton arrowButton" href="#">مشاهده</span>
            ...
            <a href="#" class="ourServicesCard">
                <div class="ourServicesCardHeader">
                    <img src="<?php bloginfo('template_directory')?>/img/grid1.jpg"" alt="">
                    <div class="ourServicesCardFooter">
                       <img decoding="async" src="https://templatekit.jegtheme.com/quinnie/wp-content/uploads/sites/170/2021/09/body.png" alt="Body Shaping">
                        <div class="ourServicesCardFooterInner">
                            <h3>کربوکسی تراپی تیرگی</h3>
                            <span>درمان سیاهی زیر چشم با استفاده از متد کربوکسی تراپی</span>
                            <span class="generalButton arrowButton" href="#">مشاهده</span>
            ...
            <a href="#" class="ourServicesCard">
                <div class="ourServicesCardHeader">
                    <img src="<?php bloginfo('template_directory')?>/img/grid1.jpg"" alt="">
                    <div class="ourServicesCardFooter">
                        <img decoding="async" src="https://templatekit.jegtheme.com/quinnie/wp-content/uploads/sites/170/2021/09/buttock.png" alt="Buttocks Reshape">
                        <div class="ourServicesCardFooterInner">
                            <h3>کربوکسی تراپی تیرگی</h3>
                            <span>درمان سیاهی زیر چشم با استفاده از متد کربوکسی تراپی</span>
                            <span class="generalButton arrowButton" href="#">مشاهده</span>
...
<div class="clkarenHomeOurApproachContainer">
    <div class="clkarenOurApproachSection mainView">
        <div class="homeOurApproachContentPart">
            ...
            <div class="homeOurApproachCard">
                <div class="aboutUsCardIconPart">
                    <div class="aboutUsCardIconPartInner">
                        <svg width="50" height="50" viewBox="-0.375 -0.125 1.5 1.5" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin" class="jam jam-phone"><path d="M.188 0h.375a.188.188 0 0 1 .188.188v.875a.188.188 0 0 1-.188.188H.188A.188.188 0 0 1 0 1.063V.188A.188.188 0 0 1 .188 0zm0 .125a.063.063 0 0 0-.063.063v.875a.063.063 0 0 0 .063.063h.375a.063.063 0 0 0 .063-.063V.188A.063.063 0 0 0 .563.125H.188zm.188.938a.063.063 0 1 1 0-.125.063.063 0 0 1 0 .125z"/></svg>
                    </div>
                </div>
            ...
            <div class="homeOurApproachCard">
                <div class="aboutUsCardIconPart">
                    <di class="aboutUsCardIconPartInner">
                ...
                <div class="swiper-slide innerSwiper">
                    ...
                    <div class="homeAboutUsFounderPart">
                        <div class="founderPartImg">
                            <img src="http://localhost/karenclinic/wp-content/themes/karenclinic/img/founder.jpg" alt="">
                        </div>
                        <div class="founderPartName">
                            <h3>پروا گورانی</h3>
                            <span>موسس کلینیک کارن طب</span>
